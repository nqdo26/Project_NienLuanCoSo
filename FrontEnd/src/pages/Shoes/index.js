...
function Shoes() {
    ...
    const addToBag = () => {
        ...
        const product = {
            ...
            title: 'Nike Air Max SC',
            priceNew: 2189000, // Giá mới
            priceOld: null, // Giá cũ (nếu có)
            imgSrc: mainImage,
            size: size,
            color: selectedColor,
        ...
        <div className={cx('shoes')}>
            <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                >
                    ...
                    <p className={cx('description')} level={2}>
                    ...
                    <div className={cx('action-btn')}>
                        ...
                        <Button className={cx('btn')} onClick={addToFavourites} icon={<HeartOutlined />}>
                            Favourite
                        </Button>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <p>Orders are proessed and delivered Monday-Friday (excluding public holidays)</p>
                            <p>
                        ...
                        >
                            ...
                            <div style={{ marginTop: '50px' }}>
                                ...
                                <p>
                                    I hate that I have to write this because AF1 are my all-time favorite silhouette but
                                    the quality is just horrible now. Pre 2020 1 pair worn ~5 days a week lasted a year.
                                    Now they barely last 3 months.
                                    <Link to="#">More</Link>
                                </p>
                            </div>
